...
namespace BuildLightPlugin
{
  ...
  public class SucceedAction : BaseStreamDeckActionWithSettingsModel<Models.SucceedSettingsModel>
  {
	...
	public override async Task OnKeyUp(StreamDeckEventPayload args)
	{
		...
		await deviceClient.SetColorAsync (0, 255, 0, endCancellationTokenSource.Token);
